...
const Edit = (props) => {
  ...
  return (
    <>
      <EditUI handleSubmit={(values) => updateFiles(formData({ name: values.name, activity_id: values.activity_id, image: values.image, _method: 'PUT' }), `${url}/${values.id}`)} {...props} activities={data} />
