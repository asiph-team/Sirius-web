...
const Edit = (props) => {
  ...
  return (
    <>
      <EditUI handleSubmit={(values) => update({ name: values.name, description: values.description, ...(values.information && { information: values.information }), area_id: values.area_id }, `${url}/${values.id}`)} {...props} areas={data} />
